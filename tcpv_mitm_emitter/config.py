...
def runtime_config() -> dict[str, int | bool | str]:
    return {
        ...
        "stream_maxlen": env_int("TCPV_STREAM_MAXLEN", 50_000, min_value=0),
        "ttl_seconds": env_int("TCPV_TTL_SECONDS", 24 * 60 * 60, min_value=0),
        ...
        "max_events_in_memory": env_int("TCPV_MAX_EVENTS_IN_MEMORY", 50_000, min_value=1_000),
